...
public class AuthServiceIT {
    ...
    private final String EXIST_COMPANY_NAME2 = "Company2";
    private final String EXIST_USERNAME2 = "use2r";
    private final String EXIST_EMAIL2 = "email2@email.com";
    private final String EXIST_PASSWORD2 = "password2";
    ...
    void testGetUserByUsername() {
        ...
        testUser.setUsername(EXIST_USERNAME2);
        testUser.setEmail(EXIST_EMAIL2);
        testUser.setPassword(EXIST_PASSWORD2);
        testUser.setCompanyName(EXIST_COMPANY_NAME2);
        testUser.setRoles(List.of(role));

        when(mockUserRepository.findByUsername(EXIST_USERNAME)).thenReturn(Optional.of(testUser));

        assertThrows(UsernameNotFoundException.class, () ->
                authServiceToTest.getUserByUsername(NOT_EXIST_USERNAME));
    }
    ...
    void testGetByEmail(){
        ...
        testUser.setCompanyName(EXIST_COMPANY_NAME);
        testUser.setRoles(List.of(role));
        when(mockUserRepository.findByEmail(EXIST_EMAIL)).thenReturn(Optional.of(testUser));
    ...
    void testGetByEmail_Not_Founded(){
        String INVALID_EMAIL= "test@email.bg";
        User testUser = new User();
        testUser.setUsername(EXIST_USERNAME);
        testUser.setEmail(EXIST_EMAIL);
        testUser.setPassword(EXIST_PASSWORD);
        ...
        User user = authServiceToTest.getByEmail(INVALID_EMAIL);
        String value = null;
        assertEquals(value, user.getEmail());
