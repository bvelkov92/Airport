...
public class FlightServiceTest {
    ...
    private final LocalDateTime DATE_TIME = LocalDateTime.parse("2023-04-16T19:33");
    ...
    void testAddFlight(){
        ...
        dto.setTime(DATE_TIME.toString());
        ...
        assertEquals(DATE_TIME, savedFlight.getTimeOfFlight());
    ...
    void testFindFlight(){
        ...
        validDto.setTime(DATE_TIME.toString());
        ...
        invalidDto.setTime(DATE_TIME.toString());
        ...
        Flight testFlight = new Flight();
                ...
                testFlight.setTimeOfFlight(DATE_TIME);
    ...
    void testCheckTimeDifference(){
        ...
        LocalDateTime invalidTime = LocalDateTime.now().minusDays(5);
        LocalDateTime validTime = LocalDateTime.now().plusDays(2);
